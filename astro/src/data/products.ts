...
export const products: Product[] = [
  ...
  { model:'Dual USB 3.1A Car Charger BT 5.3 FM Transmitter PD 18W Type-C Colorful Ambient Light MP3 Music Player 5V/1A Cigarette Lighter', slug:'/products/chargers/dual-usb-31a-bt53-fm-transmitter-car-charger/', family:'Charger', interface:'Vehicle cigarette-lighter car charger / FM transmitter format shown with USB, Type-C, LED frequency display, music/call controls and colorful ambient light; exact port map requires selected-SKU evidence', power:'Dual USB 3.1A, PD 18W Type-C and 5V/1A cues listed by user and images; exact output map, current sharing and vehicle input range require selected-SKU evidence', dataRate:'BT 5.3, FM transmitter and MP3 music player cues listed; Bluetooth chipset, profiles, FM range, storage support and audio formats require selected-SKU evidence', video:'Not positioned for display output', material:'Black cigarette-lighter charger housing with colorful ambient-light trim shown; exact shell material, heat design and internal protection design require source confirmation', lengths:'Vehicle plug-in transmitter / charger; packaging image shows 800 mm cable cue that requires selected-package confirmation', bestFor:'Wholesale car accessory, FM transmitter, Bluetooth handsfree, MP3 music player and private-label in-car charging programs needing custom packaging and logo review', customization:['MOQ 100 pcs','100-499 pcs: US$5.20 / piece','500-999 pcs: US$5.10 / piece','1000+ pcs: US$4.80 / piece','Custom packaging supported','Logo supported','Packaging, logo, button artwork, light trim and function set by quotation'], proofStatus:'User-provided title, commercial terms and product images captured; exact BT5.3 chipset, FM range, PD 18W Type-C behavior, 3.1A/5V1A output map, MP3 support, protection design, ambient-light modes, logo, packaging and compliance require selected-model evidence', detailReady:true, cardLabel:'BT5.3 FM car charger', cardFacts:[{label:'MOQ',value:'100 pcs'},{label:'100-499 pcs',value:'US$5.20 / piece'},{label:'500-999 pcs',value:'US$5.10 / piece'},{label:'1000+ pcs',value:'US$4.80 / piece'}],
    images:[
      {src:'/images/products/dual-usb-31a-bt53-fm-transmitter-car-charger/01-main.webp',alt:'Dual USB 3.1A BT5.3 FM transmitter car charger with colorful ambient light and retail box cue',label:'Product and packaging cue'},
      {src:'/images/products/dual-usb-31a-bt53-fm-transmitter-car-charger/02-protection.webp',alt:'Supplier image showing car charger protection cues including electrostatic high temperature short circuit overcurrent overload and magnetic field protection',label:'Protection cue'},
      {src:'/images/products/dual-usb-31a-bt53-fm-transmitter-car-charger/03-car-charging.webp',alt:'Supplier image showing in-car phone charging cue for Huawei Samsung Honor and other mobile phones',label:'In-car charging cue'},
      {src:'/images/products/dual-usb-31a-bt53-fm-transmitter-car-charger/04-dashboard-use.webp',alt:'Dual USB car charger installed in vehicle cigarette lighter with Type-C 1A and 3A port labels colorful ambient light and 108.0 display',label:'Dashboard use cue'}
    ],
    featureHighlights:[
      {title:'Order terms',value:'MOQ 100 pcs',note:'User-supplied price tiers are recorded for RFQ review and should be reconfirmed before order.',image:'/images/products/dual-usb-31a-bt53-fm-transmitter-car-charger/01-main.webp',alt:'Dual USB 3.1A BT5.3 FM transmitter car charger product and box'},
      {title:'Function cues',value:'BT5.3 + FM + MP3 listed',note:'BT5.3, FM transmitter, MP3 music player and colorful ambient-light cues are listed; chipset, audio behavior and light modes require selected-SKU evidence.',image:'/images/products/dual-usb-31a-bt53-fm-transmitter-car-charger/04-dashboard-use.webp',alt:'Car charger installed in cigarette lighter with colorful ambient light'},
      {title:'Charging layout',value:'Dual USB + Type-C cues',note:'The request lists dual USB 3.1A, PD 18W Type-C and 5V/1A cues; output map and shared-load behavior require selected-SKU test evidence.',image:'/images/products/dual-usb-31a-bt53-fm-transmitter-car-charger/03-car-charging.webp',alt:'In-car phone charging cue for the car charger'}
    ],
    sourceSnapshot:'User-provided product title, commercial terms and images reviewed 24 Sep 2026. Values below reproduce supplied material and are not independent certification evidence.',
    supplierClaims:[
      ['Listing title','Dual USB 3.1A Car Charger BT 5.3 FM Transmitter PD 18W Type-C Colorful Ambient Light MP3 Music Player 5V/1A Cigarette Lighter'],
      ['Product format','Vehicle cigarette-lighter car charger / Bluetooth FM transmitter / MP3 music player'],
      ['Bluetooth cue','BT 5.3 listed by user; chipset, range and profiles require evidence'],
      ['Charging cue','Dual USB 3.1A, PD 18W Type-C and 5V/1A cues listed; exact output map requires selected-SKU confirmation'],
      ['Port cue','Supplied images show Type-C, 1A and 3A port labels plus a frequency display and music/call controls'],
      ['Display cue','108.0 LED frequency-style display shown in supplied images'],
      ['Lighting cue','Colorful ambient-light trim shown; exact lighting modes require confirmation'],
      ['Music cue','MP3 music player listed in title; supported storage, formats and controls require confirmation'],
      ['Protection cue','Images list electrostatic, high temperature, short circuit, overcurrent, overload and magnetic field protection; test evidence and design details require confirmation'],
      ['Packaging cue','Retail box cue shown; custom packaging support listed by user'],
      ['Cable cue','Packaging image includes Length: 800 mm cue; confirm whether this is cable, accessory or package-specific before publication'],
      ['Vehicle use','Cigarette lighter format shown; voltage range, fit and compatibility require sample confirmation'],
      ['Source boundary','BT, FM, charging, protection, ambient light and MP3 claims remain supplier/listing cues until model-level evidence is provided']
    ],
    packagingClaims:[
      ['MOQ','100 pieces'],
      ['Price: 100-499 pieces','US$5.20 / piece'],
      ['Price: 500-999 pieces','US$5.10 / piece'],
      ['Price: 1000+ pieces','US$4.80 / piece'],
      ['Customization','Custom packaging and logo supported; confirm artwork, logo position, button markings, box layout, barcode and carton data by quotation'],
      ['Lead time','Not provided in supplied material; confirm by current quotation']
    ] },
